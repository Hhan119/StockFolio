    ...
    <section className="grid min-h-[60vh] place-items-center">
      ...
      <div className="max-w-xl rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm">
        ...
        <div className="mt-5 flex justify-center gap-2">
          <Link className="rounded-xl bg-slate-950 px-4 py-3 text-sm font-black text-white" to="/">홈</Link>
          <Link className="rounded-xl bg-slate-100 px-4 py-3 text-sm font-black text-slate-700" to="/etf">ETF 목록</Link>
        </div>
      </div>
    </section>
  );
