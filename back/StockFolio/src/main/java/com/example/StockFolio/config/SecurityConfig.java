...
import com.example.StockFolio.filter.JwtFilter;
import com.example.StockFolio.service.UserDetailService;
...
public class SecurityConfig {
    ...
    @Value("${app.cors.allowed-origins:http://localhost:8888}")
